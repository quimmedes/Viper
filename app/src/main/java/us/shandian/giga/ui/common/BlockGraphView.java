...
public class BlockGraphView extends View
{
	...
	public BlockGraphView(Context context, AttributeSet attrs, int defStyle) {
		...
		try {
			TypedArray array = context.obtainStyledAttributes(R.styleable.ButtonBarContainerTheme);
			mBackground = array.getColor(R.styleable.ButtonBarContainerTheme_metaButtonBarStyle, 0);
			mForeground = array.getColor(R.styleable.ButtonBarContainerTheme_metaButtonBarButtonStyle, 0);
			array.recycle();
		} catch (Exception e) {
