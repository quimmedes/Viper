...
public class AnoFragment extends Fragment implements Pager, OnItemClickListener {
    ...
    public void onItemClick(View view, int i) {
        Canal item = ((CanalAdapter) AnoFragment.this.gridview.getAdapter()).getItem(i);
        Intent intent = new Intent(AnoFragment.this.getActivity(), ActivityEpisodio.class);
    ...
    public void doBackground() {
        ...
        call = service.GetOdataAlphabet("substringof('"+ano.replace("'","''")+"',Ano)", "Id,Nome,Imagem,Ano", "Nome", String.valueOf(this.skip), "allpages");
        ...
        call.enqueue(new Callback<Odata>() {
            ...
            public void onResponse(Call<Odata> call, Response<Odata> response) {
                ...
                AnoFragment listaAnimeFragment = AnoFragment.this;
