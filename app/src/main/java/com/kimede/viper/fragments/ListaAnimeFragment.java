...
public class ListaAnimeFragment extends Fragment implements Pager , OnItemClickListener  {
    ...
    public void onItemClick(View view, int position) {
        Canal a = ((CanalAdapter) ListaAnimeFragment.this.gridview.getAdapter()).getItem(position);
        Intent it = new Intent(ListaAnimeFragment.this.getActivity(), ActivityEpisodio.class);
        it.putExtra("anime", a);
    ...
    public void doBackground() {
        ...
        if (this.letra.contains("#")) {
            call = service.GetOdataAlphabet("substringof('',Nome)", "Id,Nome,Imagem", "Nome", String.valueOf(this.skip), "allpages");
        } else {
            call = service.GetOdataAlphabet("startswith(Nome,'" + this.letra + "')", "Id,Nome,Imagem", "Nome", String.valueOf(this.skip), "allpages");
        }
        call.enqueue(new Callback<Odata>() {
            ...
            public void onResponse(Call<Odata> call, Response<Odata> response) {
                ...
                if (((Odata) response.body()).getOdataCount() != null) {
                    ListaAnimeFragment.this.total = Integer.parseInt(((Odata) response.body()).getOdataCount());
                }

                ListaAnimeFragment listaAnimeFragment = ListaAnimeFragment.this;
